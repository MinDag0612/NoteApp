        ...
        try {
            ...
            $mail->Body = '
                <div style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">
                    ...
                    // <p><a href="http://localhost:80/NoteApp/verify.php?token=' . $token . '" style="color: #1a73e8;">Xác thực</a></p>
                    <p><a href="/NoteApp/verify.php?token=' . $token . '" style="color: #1a73e8;">Xác thực</a></p>
